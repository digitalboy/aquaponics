...
| **⚪ 白色 (White)** | 理化分析实验室 (`QA`) | 洁净环境专用，严禁带入泥泞生产区。 |
...
### 3.2 表2：实验室与计量化验仪器台账 (`tbl_laboratory_instruments`)
...
| **存放房间与工位** | SingleSelect (单选) | 是 | `IQC理化检测室`、`4°C留样室`、`水质快速检测台` | 实验室空间定置 |
