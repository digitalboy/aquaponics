...
mindmap
  root((拓展话题与多模态集成))
    ...
    ["9.3 跨系统复合延伸"]
      ["浓缩固废与排污水大田果园灌溉"]
      ["毛细自吸芯吸床 Wicking Beds（块根块茎种植）"]
    ["9.4 全球创新案例剖析"]
      ["缅甸重力流小农生计鱼菜示范"]
      ["微咸水共生：海鲈/鲷鱼与盐地碱蓬"]
      ["印尼池塘 Yumina 菜鱼与 Bumina 果鱼模式"]
```
...
mindmap
  root((农场内生替代饲料库))
    ...
    昆虫与无脊椎鲜活蛋白
      ["黑水虻幼虫 BSF：粗蛋白 42% 与优质脂质 35%"]
      ["赤子爱胜蚓红蚯蚓：粗蛋白 60% 与促摄食活性"]
      ["蝇蛆干粉：鲜活诱食"]
```
...
```mermaid
flowchart TD
    subgraph Wicking ["芯吸床解剖结构 (深度 50 cm)"]
