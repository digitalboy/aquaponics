...
为满足 [06_全球主要国家与地区农业食品安全标准比对规范.md](../05_specifications/06_全球主要国家与地区农业食品安全标准比对规范.md) 中欧盟最严生菜硝酸盐限值（$< 4000\text{ mg/kg}$）及母婴级标准（$< 800\text{ mg/kg}$），系统在采收前 48 小时触发以下生化调控：
...
* **品质控制与实验室子系统**：👉 [07_品质控制与实验室子系统.md](./07_品质控制与实验室子系统.md)
* **水培种植子系统与调理池加药**：👉 [02_水培种植子系统.md](./02_水培种植子系统.md)
* **能耗优化子系统与 MPC 光效对冲**：👉 [03_能耗优化子系统.md](./03_能耗优化子系统.md)
* **作物蒸腾量估算与感知算法规范**：👉 [03_温室作物蒸腾量估算与感知算法规范.md](../05_specifications/03_温室作物蒸腾量估算与感知算法规范.md)
