...
│   ├── 03_分期实施计划书.md                           # 三期投资计划书 (一期 6.62 万元闭环，含国数全金属DO/在线氨氮/500米双层桥架/分布式24V电源/TP-Link全家桶/人工)
│   ├── 04_第一期数据采集与自动控制硬件采购BOM与工程施工清单.md # 🛒 采集与自控物料清单、订货SKU、辅材包与进场防伪验货标准
│   ├── 06_全厂强电动力配电与电气工程规划规范.md       # ⚡ 380V动力负荷计算、分级动力箱矩阵、D型断路器与强弱电协同SOP
│   ├── 07_深圳光明基地双棚跨区大闭环水循环系统工程设计规范.md # 🌊 跨区双棚联动循环水动力与管网设计
│   └── 08_初级农艺师现场作业技能清单与实操SOP.md       # 🧑‍🌾 一线初中文化通俗实操：5S保洁/工具防丢/育苗定植/喂鱼观察与20项通关考核
│
...
│   └── 10_全厂实物资产台账与5S定置管理数据契约规范(Asset_and_5S_Ledger_Schema).md # 📋 五层资产分治、5S影子板形迹管理、飞书Base五大分表Schema与Zod数据契约
│
...
* 研读 [03_分期实施计划书.md](./02_requirements_and_plans/03_分期实施计划书.md) 掌握第一期 **¥ 6.62 万元** 高性价比落地路线与 8 周开发进度。
* 查阅 [04_第一期数据采集与自动控制硬件采购BOM与工程施工清单.md](./02_requirements_and_plans/04_第一期数据采集与自动控制硬件采购BOM与工程施工清单.md) 获取精准 SKU 订货号、小五金辅材包与通电验收 Checklist。
* 查阅 [05_现场弱电线缆选型与布线施工规范.md](./02_requirements_and_plans/05_现场弱电线缆选型与布线施工规范.md) 掌握弱电智能化架构、固定IP字典、485站号字典、UPS断电保命与线缆快拆施工工艺标准。
* 查阅 [06_全厂强电动力配电与电气工程规划规范.md](./02_requirements_and_plans/06_全厂强电动力配电与电气工程规划规范.md) 掌握 380V/220V 负荷计算、分级动力箱回路、电缆截面载流量、ATS 应急自投及防雷接地规范。
* 查阅 [07_深圳光明基地双棚跨区大闭环水循环系统工程设计规范.md](./02_requirements_and_plans/07_深圳光明基地双棚跨区大闭环水循环系统工程设计规范.md) 掌握跨区连通双棚的大闭环水力循环管道标高与压力平衡计算。
* **【一线实操红宝书】** 查阅 [08_初级农艺师现场作业技能清单与实操SOP.md](./02_requirements_and_plans/08_初级农艺师现场作业技能清单与实操SOP.md) 掌握面向初中文化一线员工的大白话实操规范（打扫卫生/影子板防丢/海绵育苗定植/慢撒喂鱼看浮头及20项通关考核打勾清单）。
...
* **【实物资产与 5S 定置中台】** 查阅 [10_全厂实物资产台账与5S定置管理数据契约规范(Asset_and_5S_Ledger_Schema).md](./03_system_architecture/10_全厂实物资产台账与5S定置管理数据契约规范(Asset_and_5S_Ledger_Schema).md) 掌握五层实物资产分治、5S影子板形迹管理、三色生物安全防线、飞书多维表格五大分表 Schema 字典与自动化预警工作流。
