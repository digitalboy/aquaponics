...
│   ├── 01_水产养殖子系统.md                          # 荧光 DO 监测 (深圳国数全金属质保3年)、24h在线氨氮反演、PLC 保命与 YOLO11 估重
...
└── 05_specifications/                                 # 📌 05. 专项工程技术规范 (Single Source of Truth)
    ...
    ├── 04_大空间温室立体微气候感知与温控策略规范.md    # 8.1米大空间垂直分层测温阵列、室外超声波气象站与三级温控策略
    ├── 05_现场弱电线缆选型与布线施工规范.md            # 工业弱电线缆矩阵、超五类网线/RVSP4芯接线与低成本快拆施工标准
    └── 06_全球主要国家与地区农业食品安全标准比对规范.md # 欧盟EU/日本肯定列表/中国GB/美国FDA/德瑞私标全景对比与工厂内控SOP
```
...
* 查阅 [01_用户故事与需求矩阵.md](./02_requirements_and_plans/01_用户故事与需求矩阵.md) 了解养殖长、种植长、工程电工、大客户销售经理、B端商超采购主管、C端家庭消费者及集团高管的核心诉求与 KPI。
* 参考 [02_全体系调研提纲.md](./02_requirements_and_plans/02_全体系调研提纲.md) 执行基地一线硬件资产与数据断层的实地踏勘。
* 研读 [03_分期实施计划书.md](./02_requirements_and_plans/03_分期实施计划书.md) 掌握第一期 **¥ 5.80 万元**（硬件 CAPEX ¥4.50万 + 施工人工 ¥1.00万 + AI OPEX ¥0.30万）高性价比落地路线与 8 周开发进度。
* 查阅 [04_第一期硬件采购BOM与工程施工清单.md](./02_requirements_and_plans/04_第一期硬件采购BOM与工程施工清单.md) 获取现场采购专员与施工电工的精准 SKU 订货号、深圳国数全不锈钢 DO 探头、热浸锌双层桥架系统、施工工日定额、小五金辅材包及通电验收 Checklist。
...
* **水产养殖**：[01_水产养殖子系统.md](./04_subsystems/01_水产养殖子系统.md)（荧光 DO 监测、PLC 0.1s 硬件保命、AI 抢食投喂）
* **水培种植**：[02_水培种植子系统.md](./04_subsystems/02_水培种植子系统.md)（VPD/PPFD 软反演、调理池脉冲加药、蒸腾量估算）
* **能耗优化**：[03_能耗优化子系统.md](./04_subsystems/03_能耗优化子系统.md)（分回路能耗计量、分时电价 TOU 下的 MPC 热泵套利）
* **机器人控制**：[04_智能调度与机器人.md](./04_subsystems/04_智能调度与机器人.md)（RCS 金字塔调度、VDA 5050 与力控具身收割）
...
* **8.1m 大空间温室立体微气候感知与温控策略规范**：[04_大空间温室立体微气候感知与温控策略规范.md](./05_specifications/04_大空间温室立体微气候感知与温控策略规范.md)
* **现场弱电线缆选型与布线施工规范**：[05_现场弱电线缆选型与布线施工规范.md](./05_specifications/05_现场弱电线缆选型与布线施工规范.md)
...
> 3. **人身与生物安全**：现场部署的 AMR 无人车必须配置超声波防撞与物理碰条；PLC 梯形图的“应急曝气与投喂熔断”硬件逻辑高于一切上层软件与云端 AI 指令（详见 [01_水产养殖子系统.md](./04_subsystems/01_水产养殖子系统.md) 与 [04_智能调度与机器人.md](./04_subsystems/04_智能调度与机器人.md)）。
