...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-base font-bold leading-none tracking-tight text-slate-100 flex items-center gap-2',
      className
    )}
    {...props}
  />
